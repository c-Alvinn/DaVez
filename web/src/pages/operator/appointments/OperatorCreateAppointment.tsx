...
export default function OperatorCreateAppointment() {
            ...
            <div className="max-w-4xl w-full mx-auto">
                <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="flex-1 space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <button
                                        ...
                                        className="absolute right-2 top-1/2 -translate-y-1/2 p-2.5 rounded-xl bg-primary text-background-dark hover:bg-primary/90 transition-all disabled:opacity-50"
                                    >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/* Transportadora */}
                        <div className="bg-white/[0.03] border border-white/5 p-6 rounded-[2rem] space-y-2 md:col-span-2">
                            <label className={labelClass}>
